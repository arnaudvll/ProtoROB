...
void setupDynamixel(uint8_t dxl_id)
{
  ...
  // if (dxl_comm_result != COMM_SUCCESS) {
  //   RCLCPP_ERROR(rclcpp::get_logger("read_write_node"), "Failed to enable CCW.");
  // } else {
  //   RCLCPP_INFO(rclcpp::get_logger("read_write_node"), "Succeeded to enable CCW.");
  // }


  //   // Enable CW of DYNAMIXEL
  // dxl_comm_result = packetHandler->write1ByteTxRx(
  //   portHandler,
  //   dxl_id,
  //   ADDR_CW_ANGLE_LIMIT,
  ...
  // if (dxl_comm_result != COMM_SUCCESS) {
  //   RCLCPP_ERROR(rclcpp::get_logger("read_write_node"), "Failed to enable CW.");
  // } else {
  //   RCLCPP_INFO(rclcpp::get_logger("read_write_node"), "Succeeded to enable CW.");
  // }
